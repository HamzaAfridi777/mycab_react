...
const RideRequest = ({ userRole }) => {
  ...
  const columns = useMemo(() => [
    ...
    { Header: 'Customer_PickUp_Location', accessor: 'customer_pickup_location' },
    { Header: 'Customer_Drop_Location', accessor: 'customer_drop_location' },
    {
      Header: 'Actions',
          ...
          <div className="col-xs-12">
            <div className="box">
              <div className="box-header">
                <h3 className="box-title pull-left"><b>Ride List</b></h3>
                <div >
                  <input
                    type="text"
                    value={globalFilter || ''}
