...
const FranchiseonwerList = ({ userRole }) => {
  ...
  const fetchData = (role_id) => {
    ...
    axios.get('/api/Franchise-owner', config)
      .then(response => {
          ...
          <div className="col-xs-12">
            <div className="box">
              <div className="box-header">
                <h3 className="box-title pull-left"><b>Franchise Onwer </b></h3>
                <div >
                  <input
                    type="text"
                    value={globalFilter || ''}
...
export default FranchiseonwerList;
