...
const AssignedTutors = ({ userRole }) => {
  ...
  const columns = useMemo(() => [
    ...
    { Header: 'Course_Selection', accessor: 'course_selection' },
    { Header: 'Tutor_Selection', accessor: 'tutor_selection' },
    { Header: 'Start_Date', accessor: 'start_date' },
    { Header: 'End_Date', accessor: 'end_date' },
    { Header: 'Assignment_Notes', accessor: 'Assignment_notes' },
    { Header: 'Assignment_Status', accessor: 'sssignment_status'},
          ...
          <div className="col-xs-12">
            <div className="box">
              <div className="box-header">
                <h3 className="box-title pull-left"><b>Assigned Tutors List</b></h3>
                <div >
                  <input
                    type="text"
                    value={globalFilter || ''}
