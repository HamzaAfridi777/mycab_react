...
const CoursesList = ({ userRole }) => {
  ...
  const columns = useMemo(() => [
    ...
    { Header: 'Courses_Name', accessor: 'courses_name' },
    { Header: 'Course_Description', accessor: 'course_description' },
    { Header: 'Course_Category', accessor: 'course_category' },
          ...
          <div className="col-xs-12">
            <div className="box">
              <div className="box-header">
                <h3 className="box-title pull-left"><b>Course List</b></h3>
                <div >
                  <input
                    type="text"
                    value={globalFilter || ''}
