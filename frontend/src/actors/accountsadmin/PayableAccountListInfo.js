...
const PayableAccountListInfo = ({ userRole }) => {
  ...
  const fetchData = (accounts_payable_id) => {
    ...
    axios.get('api/payable-list', config)
      .then(response => {
  ...
  const columns = useMemo(() => [
    ...
    { Header: 'Purchase_journal_name', accessor: 'purchase_journal_name' },
          ...
          <div className="col-xs-12">
            <div className="box">
              <div className="box-header">
                <h3 className="box-title pull-left"><b>Payable Account List</b></h3>
                <div >
                  <input
                    type="text"
                    value={globalFilter || ''}
...
export default PayableAccountListInfo;
