...
const AbsentDriverList = ({ userRole,setAbsentDrivers }) => {
    ...
    axios.get('/api/absentDrivers-list', config)
      .then(response => {
        ...
        if (response.data && Array.isArray(response.data.data.data)) {
          ...
          setAbsentDrivers(response.data.totalAbsentDrivers)
        } else {
          ...
          <div className="col-xs-12">
            <div className="box">
              <div className="box-header">
                <h3 className="box-title pull-left"><b>Absent Driver List</b></h3>
                <div >
                  <input
                    type="text"
                    value={globalFilter || ''}
...
export default AbsentDriverList;
